...
| power_off_and_restart | 95 | SET | throttle_position | 20 | 20 | PASS | signal set |
| power_off_and_restart | 96 | WAIT |  | 300 ms | 3160 ms | PASS | wait completed |
| power_off_and_restart | 97 | ASSERT | ecu_state | EQ 4.000000 | 4.000000 | PASS | assertion passed |
| power_off_and_restart | 98 | POWER | ecu | power OFF | POWER_OFF | PASS | power switched |
| power_off_and_restart | 99 | ASSERT | ecu_state | EQ 0.000000 | 0.000000 | PASS | assertion passed |
| power_off_and_restart | 100 | ASSERT | engine_speed | EQ 0.000000 | 0.000000 | PASS | assertion passed |
| power_off_and_restart | 101 | POWER | ecu | power ON | INIT | PASS | power switched |
| power_off_and_restart | 102 | ASSERT | ecu_state | EQ 1.000000 | 1.000000 | PASS | assertion passed |
| power_off_and_restart | 103 | SET | throttle_position | 20 | 20 | PASS | signal set |
| power_off_and_restart | 104 | WAIT |  | 300 ms | 3460 ms | PASS | wait completed |
| power_off_and_restart | 105 | ASSERT | ecu_state | EQ 4.000000 | 4.000000 | PASS | assertion passed |
| power_off_and_restart | 106 | ASSERT | engine_speed | GT 800.000000 | 2040.000000 | PASS | assertion passed |
| power_off_and_restart | 107 | END |  |  |  | PASS | test case ended |
| comm_timeout_recoverable | 110 | SET | throttle_position | 20 | 20 | PASS | signal set |
| comm_timeout_recoverable | 111 | WAIT |  | 300 ms | 3760 ms | PASS | wait completed |
| comm_timeout_recoverable | 112 | ASSERT | ecu_state | EQ 4.000000 | 4.000000 | PASS | assertion passed |
| comm_timeout_recoverable | 113 | FAULT | ECU | ECU COMM | FAULT latched=0 | PASS | ECU fault injected |
| comm_timeout_recoverable | 114 | ASSERT | ecu_state | EQ 5.000000 | 5.000000 | PASS | assertion passed |
| comm_timeout_recoverable | 115 | WAIT |  | 20 ms | 3780 ms | PASS | wait completed |
| comm_timeout_recoverable | 116 | ASSERT | engine_speed | EQ 0.000000 | 0.000000 | PASS | assertion passed |
| comm_timeout_recoverable | 117 | FAULT | ECU | ECU CLEAR | RECOVERY latched=0 | PASS | ECU fault injected |
| comm_timeout_recoverable | 118 | ASSERT | ecu_state | EQ 6.000000 | 6.000000 | PASS | assertion passed |
| comm_timeout_recoverable | 119 | WAIT |  | 300 ms | 4080 ms | PASS | wait completed |
| comm_timeout_recoverable | 120 | ASSERT | ecu_state | EQ 4.000000 | 4.000000 | PASS | assertion passed |
| comm_timeout_recoverable | 121 | END |  |  |  | PASS | test case ended |
| ecu_latched_fault | 124 | SET | throttle_position | 20 | 20 | PASS | signal set |
| ecu_latched_fault | 125 | WAIT |  | 300 ms | 4380 ms | PASS | wait completed |
| ecu_latched_fault | 126 | ASSERT | ecu_state | EQ 4.000000 | 4.000000 | PASS | assertion passed |
| ecu_latched_fault | 127 | FAULT | ECU | ECU LATCH | FAULT latched=1 | PASS | ECU fault injected |
| ecu_latched_fault | 128 | ASSERT | ecu_state | EQ 5.000000 | 5.000000 | PASS | assertion passed |
| ecu_latched_fault | 129 | ASSERT | ecu_fault_latched | EQ 1.000000 | 1.000000 | PASS | assertion passed |
| ecu_latched_fault | 130 | WAIT |  | 1000 ms | 5380 ms | PASS | wait completed |
| ecu_latched_fault | 131 | ASSERT | ecu_state | EQ 5.000000 | 5.000000 | PASS | assertion passed |
| ecu_latched_fault | 132 | ASSERT | engine_speed | EQ 0.000000 | 0.000000 | PASS | assertion passed |
| ecu_latched_fault | 133 | FAULT | ECU | ECU CLEAR | RECOVERY latched=0 | PASS | ECU fault injected |
| ecu_latched_fault | 134 | ASSERT | ecu_state | EQ 6.000000 | 6.000000 | PASS | assertion passed |
| ecu_latched_fault | 135 | ASSERT | ecu_fault_latched | EQ 0.000000 | 0.000000 | PASS | assertion passed |
| ecu_latched_fault | 136 | END |  |  |  | PASS | test case ended |
